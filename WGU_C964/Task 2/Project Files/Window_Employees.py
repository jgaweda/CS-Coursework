...
def data_filter1_employee_names(data_to_be_filtered, index, updated_field):
    ...
    if result == 0:
        ...
        if result == 0:
            ...
            data_to_be_filtered = employee_names()
            get_hashmap().get(str(index))[updated_field] = data_to_be_filtered
            update_counter1_noise()


def data_filter1_employee_emails(data_to_be_filtered, index, updated_field):
    result = random.randint(0, 1)
    if result == 0:
        pass
    else:
        ...
        if result == 0:
            ...
            data_to_be_filtered = employee_emails()
            get_hashmap().get(str(index))[updated_field] = data_to_be_filtered
            update_counter1_noise()


def data_filter2_employee_names(data_to_be_filtered, index, updated_field):
    result = random.randint(0, 1)
    if result == 0:
        pass
    else:
...
def data_filter2_employee_emails(data_to_be_filtered, index, updated_field):
    result = random.randint(0, 1)
    if result == 0:
        pass
    else:
